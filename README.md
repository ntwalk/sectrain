...
Disclaimer: Follow all rules of the creator of the tools or solutions you use. Some of the tools or content have offensive capability or contain malware or vulnerabilities which should only be used in a controlled lab environment. Use at your own risk. This document is subject to change at any time and is not an all-Inclusive list of resources that can be leveraged to learn about Information Security.

Tips: Start learning about subjects like: Data Loss Prevention, insider threat, malware and cryptography.
      Also start taking a little time each day to start learning some new skills. Skills that would benefit you and the team could be:  SQL, PowerShell, Python, C+, C#, or Java.

When you start making progress with these skills, add them to your resume but be careful to realistically portray your skill level. If you are a beginner, say so.
Better to say it there than to have it come out in a technical interview.
...
- [NWA Council](http://www.nwacouncil.org/)
- [Things To Do In Northwest Arkansas](http://www.northwestarkansas.org/things-to-do/general-attractions/)
...
- [SANS RSS Feed](https://www.sans.org/newsletters/)
- [SANS](https://www.sans.org/)


## Recommended Twitter Accounts to Follow
- [@JerryRGeisler](https://twitter.com/JerryRGeisler)
- [@adamely](https://twitter.com/adamely)
- [@jrmorrow](https://twitter.com/jrmorrow43)
- [@malcomvetter](https://twitter.com/malcomvetter)
- [@Sp4rkCon](https://twitter.com/Sp4rkCon)
...
- [IDS/IPS](https://www.sans.org/reading-room/whitepapers/detection/understanding-ips-ids-ips-ids-defense-in-depth-1381)
...
- [Cybrary: Free security analyst, IT skills, and pen testing training](https://www.cybrary.it/)
- [Hacksplaining: Common Attacks](https://www.hacksplaining.com/)
- [University of Maryland Cybersecurity](https://www.coursera.org/specializations/cybersecurity?utm_medium=courseDescripTop)
- [edX Information Security courses](https://www.edx.org/course?search_query=cybersecurity)
- [Coursera Information Security courses](https://www.coursera.org/courses?query=cybersecurity)

## Learn SQL
- [SQL Couse](http://www.sqlcourse.com/)
- [SoloLearn](https://www.sololearn.com/Course/SQL/)
- [Codecademy](https://www.codecademy.com/learn/learn-sql)
- [Vertabelo](https://academy.vertabelo.com/course/sql-practice-set#)*paid
